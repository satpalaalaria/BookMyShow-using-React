...
const ResponsiveAppBar = ({userData,fetchSearchMovie}) => {
    ...
    const optimision=useCallback(debounce(handleClick),[])
    return (
        <div className='main-header-appbar'>
            <AppBar position="static" style={{ backgroundColor: "rgb(51, 53, 69)" }} >
                <Container maxWidth="xl">
                    <Toolbar disableGutters className='header_toolbar'>
                        <a className="sc-iGrrsa bOWwtS" href='https://bookmyshow-using-react-redux.netlify.app/'>
            ...
            <AppBar className='secound-navbar' position="static" style={{ backgroundColor: "rgb(31, 37, 51)" }}>
                ...
                <a href='/' style={{ textDecoration: 'none',color:'white',fontWeight:'bold' }}>Home</a>
...
const mapDispatchToProps = dispatch => {
    ...
    return {
        fetchSearchMovie: (value) => dispatch(fetchSearchMovie(value))
    }
}
